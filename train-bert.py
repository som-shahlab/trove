...
from inkfish.models.loss import SoftCrossEntropyLoss
from inkfish.analysis.metrics import score_sequences
...
def main(args):
    ...
    criterion = inkfish.models.loss.SoftCrossEntropyLoss()
